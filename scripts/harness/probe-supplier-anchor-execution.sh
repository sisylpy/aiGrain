...
#
# 用法:
#   ./scripts/harness/probe-supplier-anchor-execution.sh
#   API_BASE=http://localhost:8090/api ./scripts/harness/probe-supplier-anchor-execution.sh
#
...
TS="$(date +%Y%m%d-%H%M%S)"
OUT="${PROBE_SUPPLIER_ANCHOR_EXECUTION_OUT:-$HOME/Desktop/aigrain-probe-supplier-anchor-execution-${TS}.json}"
    ...
    | "--- round \(.roundIndex) ---",
      ...
      (.resolvedQueryContextSummary // {}
        | "structuredIntentDetailWire=\(.structuredIntentDetailWire // "null")",
          ...
          "executionIntentType=\(.executionIntentType // "null")",
          "executionDetailWanted=\(.executionDetailWanted // "null")",
          "focusEntityType=\(.focusEntityType // "null")",
          "focusEntityName=\(.focusEntityName // "null")",
          "focusEntityId=\(.focusEntityId // "null")",
          "matchedContractId=\(.matchedContractId // "null")",
