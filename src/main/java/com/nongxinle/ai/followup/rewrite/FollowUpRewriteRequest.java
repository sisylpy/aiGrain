...
@NoArgsConstructor
@AllArgsConstructor
public class FollowUpRewriteRequest {
    ...
    public static FollowUpRewriteRequest from(
        ...
        if (previousTurn == null) {
            return FollowUpRewriteRequest.builder()
        ...
        List<String> harnessStores = previousTurn.getLastHarnessMultiStoreMatchedStores();
        return FollowUpRewriteRequest.builder()
                .rawUserMessage(rawUserMessage)
                .normalizedUserMessage(normalizedUserMessage)
                .today(today)
